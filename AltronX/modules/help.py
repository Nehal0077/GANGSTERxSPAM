...
PythonHelp = f"⚡️ ​𝐆𝐀𝐍𝐆𝐒𝐓𝐄𝐑 𝐒𝐏𝐀𝐌 𝐇𝐄𝐋𝐏 𝐌𝐄𝐍𝐔 ⚡️\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @NEHAL_OPx**"
...
async def help(event):
    if event.sender_id in SUDO_USERS:
       await event.client.send_file(event.chat_id,
                                  " https://telegra.ph/file/99ba7681c4c221c9db4dc.jpg",
                                  caption=PythonHelp,
                                  buttons=[
           [
           ...
           [    
            Button.url("⚡️ 𝐆𝐀𝐍𝐆𝐒𝐓𝐄𝐑_𝐍𝐄𝐇𝐀𝐋 ⚡️", "https://t.me/NEHAL_OPx"),
            Button.url("⚡️ 𝐆𝐀𝐍𝐆𝐒𝐓𝐄𝐑 𝐖𝐎𝐑𝐋𝐃𝐒 ⚡️", "https://t.me/gangsterworlds")
           ],
           ],
           )
...
𝐇𝐢𝐧𝐝𝐢𝐑𝐚𝐢𝐝: ᴀᴄᴛɪᴠᴀᴛᴇꜱ ʀᴇᴘʟʏ ʀᴀɪᴅ ᴏɴ ᴛʜᴇ ᴜꜱᴇʀ!!
  1) {hl}hiraid <replying to user>
  2) {hl}hiraid <username>
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
           ...
           [
            Button.url("⚡️ ᴄʜᴀɴɴᴇʟ ⚡️", "https://t.me/NEHAL_OPx"),
            Button.url("⚡️ sᴜᴘᴘᴏʀᴛ ⚡️", "https://t.me/gangsterworlds")
           ],
           ],
        )           
   else:
        await event.answer("𝗣ᴀʜʟᴇ 𝗝ᴀᴀᴋᴇ 𝗣ᴀᴘᴀ 𝗕ᴏʟ ⚡️𝐍𝐄𝐇𝐀𝐋⚡️ 𝗞ᴏ 𝗪ᴏ 𝗧ᴜᴍʜᴇ 𝗦ᴜᴅᴏ 𝗗ᴇ 𝗗ᴇɢᴀ", cache_time=0, alert=True)
...
async def help_raid(event):
     if event.query.user_id in SUDO_USERS:
        ...
        await event.answer("𝗣ᴀʜʟᴇ 𝗝ᴀᴀᴋᴇ 𝗣ᴀᴘᴀ 𝗕ᴏʟ ⚡️𝐆𝐀𝐍𝐆𝐒𝐓𝐄𝐑⚡️ 𝗞ᴏ 𝗪ᴏ 𝗧ᴜᴍʜᴇ 𝗦ᴜᴅᴏ 𝗗ᴇ 𝗗ᴇɢᴀ", cache_time=0, alert=True)
